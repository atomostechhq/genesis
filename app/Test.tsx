            ...
            <AccordionItem value="item-1">
              ...
              nisi ut aliquip ex ea commodo consequat.`}
                  <p>
                    ...
                    Sit architecto nam rerum maiores, magni omnis illum a vel
                    itaque at voluptate quas dolor harum ab hic non aperiam
                    fugit voluptatem voluptates ratione sint eligendi nihil
                    quae! Error, corrupti. Minus, magni fuga. Soluta consectetur
                    provident quia, saepe aliquid perferendis sunt
                    necessitatibus! Odio culpa suscipit et ex architecto, sint
                    nostrum, at voluptatem magnam repellat praesentium, in
                    perspiciatis quasi amet voluptatibus cumque. Omnis dolores
                    reprehenderit ipsum alias, labore inventore eligendi aperiam
                    placeat ab maiores mollitia voluptas asperiores dolorem,
                    beatae, eos illo suscipit voluptatibus! Repudiandae
                    molestiae non ab modi itaque totam, laboriosam magnam
                    consequatur.
                  </p>
                  <p>
                    {" "}
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Voluptas impedit, ex ad natus incidunt commodi? Placeat ad
                    natus non expedita corrupti atque veritatis, adipisci a
                    dicta, repellendus velit doloribus saepe officia nobis
                    deserunt reprehenderit ipsa perspiciatis nisi dolor maiores.
                    Quia, qui velit autem nam nemo recusandae reprehenderit
                    eveniet magnam sequi repellat quibusdam fugiat explicabo
                    blanditiis ratione quo dolorem assumenda debitis hic iste
                    soluta quis dolor ipsum quod deserunt. Ducimus aliquam quam
                    odio accusamus voluptas facilis quis placeat! Atque et
                    magnam adipisci quos perspiciatis, esse veritatis inventore
                    deserunt a iure aspernatur repellendus. Quod, facilis
                    laboriosam. Aliquid magnam neque quidem ducimus,
                    perspiciatis facilis aspernatur? Ipsam nesciunt natus qui ex
                    ullam mollitia dolorem! Omnis commodi obcaecati temporibus,
                    sequi nostrum reiciendis molestiae earum eos dolorem! Rem,
                    similique aut delectus nam dicta rerum laborum dolorum a
                    laboriosam nesciunt dolores iste, asperiores ipsam beatae
                    quibusdam cum molestias voluptatem eligendi ducimus ab
                    libero animi quas. Itaque ea nisi voluptas hic quos placeat
                    consectetur id fugit libero! Et a voluptate repellat autem
                    doloribus reiciendis ipsum, minima ipsam tenetur, ea
                    veritatis voluptatibus, excepturi cum ipsa labore tempore
                    nostrum corporis repudiandae impedit? Eius nam laudantium
                    animi quasi illum fugit. Neque voluptatem ipsa rem nobis
                    saepe eveniet quo itaque, voluptates accusamus?
                  </p>
                  <Input type="text" />

                  <div className="flex flex-col">
                    <section className="sticky top-0 bg-white z-10 px-4 pt-4">
                      <div className="text-display-xs font-semibold">
                        Create New Opportunity
                      </div>
                      <Divider position="horizontal" className="my-4" />
                    </section>
                    <div className="flex-1 px-4 h-[600px] overflow-y-auto">
                      <Accordion
                        type="multiple"
                        collapsible
                        className="w-full space-y-8 pb-14"
                      >
                        <AccordionItem value="item-1">
                          <AccordionTrigger>
                            Opportunity Details
                            ...
                            <section className="space-y-4">
                              ...
                              <div>
                                ...
                                <Dropdown
                                  ...
                                  setSelected={setSingleSelect}
                                  multiple={false}
                                  dropdownText="Select account name"
                                />
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="w-full pt-1">
                                    <Dropdown
                                      ...
                                      setSelected={setSingleSelect}
                                      multiple={false}
                                      dropdownText="Select number of employees"
                                    />
                                  </div>
                                </div>
                          ...
                          <AccordionContent>
                            <section className="space-y-4">
                              <div className="flex gap-4 pt-4">
                                <div className="flex-1">
                                  <Label required>Opportunity Stage</Label>
                                  <div className="w-full pt-1">
                                    <Dropdown
                                      options={multiOptions}
                                      selected={singleSelect}
                                ...
                                <div className="flex-1">
                                  ...
                                  <Dropdown
                                    ...
                                    setSelected={setSingleSelect}
                                    multiple={false}
                                    dropdownText="Select your salutation"
                                  />
                                </div>
                              </div>

                              <div>
                                <Label required>Forecast Strategy</Label>
                                <div className="w-full pt-1 !z-[1000000]">
                                  <Dropdown
                                    ...
                                    setSelected={setSingleSelect}
                                    multiple={false}
                                    dropdownText="Select forecast strategy"
                                  />
                                </div>
                              </div>
                            </section>
                    ...
                    <section className="bg-white pt-4 border-t">
